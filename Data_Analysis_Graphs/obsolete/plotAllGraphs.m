    ...
    computer_kriging_z_values, hand_kriging_z_values, scaling_factor_hand_to_computer_count, hand_image_used)
     ...
     if flag_varying_percentages_hand_count == 1
         ...
         for j = 1:num_percentages
             ...
             title_one = { [cur_type_of_apple, ' - Hand Count'], ['Percentage of Total Sections Sampled : ', string_of_percentage, '%' ] };
     ...
     if flag_varying_percentages_computer_count == 1
         ...
         if flag_plot_varying_percentages_in_one_graph == 1
            ...
            caxis([0 scale_color_bar_per_tree]);
             ...
             title('Yield Map - Ground Truth', 'fontsize', title_font_size, 'fontweight', 'bold');
             ylabel('Section', 'fontsize', axis_font_size, 'fontweight', 'normal');
             xlabel('Row', 'fontsize', axis_font_size, 'fontweight', 'normal');
             set(gca,'YTick', 1:columns_cur_map);
             set(gca,'XTick', 1:rows_cur_map);
         ...
         for j = 1:num_percentages
             ...
             caxis([0 scale_color_bar_per_tree]);
             title_one = { [cur_type_of_apple, ' - Computer Count'], ['Percentage of Total Sections Sampled : ', string_of_percentage, '%' ] };
             title(title_one, 'fontsize', title_font_size, 'fontweight', 'bold');
             ylabel('Section', 'fontsize', axis_font_size, 'fontweight', 'normal');
             xlabel('Row', 'fontsize', axis_font_size, 'fontweight', 'normal');
             set(gca, 'YTick', 1:columns_cur_map);
