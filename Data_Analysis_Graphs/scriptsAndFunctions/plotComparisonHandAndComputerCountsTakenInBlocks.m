function plotTypeOfErrorComparisonHandAndComputerCounts( all_hand_mean_errors,...
   all_computer_mean_errors, percentages_to_check, type_of_apple, Show_Continuous_Blocks_Data, percentage_to_use )
    ...
    filename = [apple_type_dir, '/type_of_error_comparison_computer_and_hand_count', string_of_loop_iterations, '_loop_iterations'];
