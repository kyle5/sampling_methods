function [ scaling_factor_hand_to_computer_count ] = computeScalingFactorFromHandToComputerCounts( hand_image_used, pc_image_used, cur_scaling_factor_percentage )
